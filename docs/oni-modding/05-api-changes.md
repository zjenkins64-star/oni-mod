...
> Verbatim from [Cairath wiki — Modding API Changes](https://github.com/Cairath/Oxygen-Not-Included-Modding/wiki/Modding-API-Changes). Synced 2026-04-26.
...
- Old hooks have been replaced by the `UserMod2` class (see [UserMod2](02-mod-structure.md#usermod2))
- The Harmony `PatchAll` can now invoked conditionally and in control of the mod developer (see [UserMod2.OnLoad](02-mod-structure.md#onload-method))
- `mod_info.yaml` gained some new fields, and `mod.yaml` was introduced (see [mod_info.yaml](02-mod-structure.md#mod_infoyaml))
